    ...
    OVS_EXCLUDED(ofproto_mutex)
{
    ...
    *ofprotop = NULL;
    ...
    FILE *fp;
    fp = fopen("home/fil02/OvS-LoOP/dpid.log","a+");
      fprintf(fp, "%ld\n",ofproto->datapath_id);
      fclose(fp);
...
void abnormal_detect1(struct ofproto *p)
{
    ...
    //   fclose(fp1);
     ...
     {    
        ...
        //   fp1=fopen("/home/fil02/OvS-LoOP/training1.log","r");  //read only for read in calculate
        ...
        {
          p->writing1=1;
        //   fp1=fopen("/home/fil02/OvS-LoOP/training1.log","a+");
        //   fprintf(fp1, "%f,%f\n",current_flow1,current_traf1);
        //   fclose(fp1);
        ...
        //   fclose(fp1);        
          ...
          float temp1;
        //   fp1= fopen("/home/fil02/OvS-LoOP/debug1.log","a+");
          for(int i=0;i<p->data_counter1;i++)
          {
        ...
        //   fp1=fopen("/home/fil02/OvS-LoOP/time1.log","a+");
        //   fprintf(fp1,"%lu\n",(end1.tv_sec - start1.tv_sec)*1000000+end1.tv_usec-start1.tv_usec);
        //   fclose(fp1);
        //   fp1=fopen("/home/fil02/OvS-LoOP/nor_training1.log","a+");
        //   for(int i=0;i<p->data_counter1;i++)
        //   {
      ...
      else 
      {
         ...
         p->loOP_status1 = LoOP_udate(p->state1,p->Data1);
          ...
          fp1= fopen("/home/fil02/OvS-LoOP/update1_p1.log","w+");
          fprintf(fp1,"%f\n",p->loOP_status1);
          fclose(fp1);
          }
      }
...
///////////////port2////////////////////////////////////////////
     ...
     {    
        ...
        //   fp1=fopen("/home/fil02/OvS-LoOP/training1_p2.log","r");  //read only for read in calculate
        // if (p->data_counter1_p2 < DATANUM && p->writing1_p2 ==1)
        if (p->data_counter1_p2 == 0 || p->writing1_p2 ==1)
        {
          p->writing1_p2=1;
          fp1=fopen("/home/fil02/OvS-LoOP/training1_p2.log","a+");
        ...
        //   fp1=fopen("/home/fil02/OvS-LoOP/time1_p2.log","a+");
        //   fprintf(fp1,"%lu\n",(end1_p2.tv_sec - start1_p2.tv_sec)*1000000+end1_p2.tv_usec-start1_p2.tv_usec);
        //   fclose(fp1);
        // //   fp1=fopen("/home/fil02/OvS-LoOP/nor_training1_p2.log","a+");
        // //   for(int i=0;i<p->data_counter1_p2;i++)
        // //   {
      ...
      else 
      {
         ...
         p->loOP_status1_p2 = LoOP_udate(p->state1_p2,p->Data1_p2);
          ...
          fp1= fopen("/home/fil02/OvS-LoOP/update1_p2.log","w+");
          fprintf(fp1,"%f\n",p->loOP_status1_p2);
          fclose(fp1);
          }
      }
...
void abnormal_detect2(struct ofproto *p)
{
    ...
    //   fclose(fp2);
     ...
     {    
        ...
        //   fp2=fopen("/home/fil02/OvS-LoOP/training2.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing2=1;
          fp2=fopen("/home/fil02/OvS-LoOP/training2.log","a+");
        ...
        //   fclose(fp2);              
          ...
          float temp2;
        //   fp2= fopen("/home/fil02/OvS-LoOP/debug2.log","a+");
          for(int i=0;i<p->data_counter2;i++)
          {
        ...
        //   fp2=fopen("/home/fil02/OvS-LoOP/time2.log","a+");
        //   fprintf(fp2,"%lu\n",(end2.tv_sec - start2.tv_sec)*1000000+end2.tv_usec-start2.tv_usec);
        //   fclose(fp2);
        //   fp2=fopen("/home/fil02/OvS-LoOP/nor_training2.log","a+");
        //   for(int i=0;i<p->data_counter2;i++)
        //   {
      ...
      else if (p->training2 ==2)
      {
         ...
         p->loOP_status2 = LoOP_udate(p->state2,p->Data2);
          ...
          fp2= fopen("/home/fil02/OvS-LoOP/update2_p1.log","w+");
          fprintf(fp2,"%f\n",p->loOP_status2);
          fclose(fp2);
          }
      }
 ...
 /*--------------------port2 ------------------------------------------*/
     ...
     {    
        ...
        //   fp2=fopen("/home/fil02/OvS-LoOP/training2_p2.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        // //if(fp2==NULL || p->writing2 == 1)
        ...
        {
          p->writing2_p2=1;
          fp2=fopen("/home/fil02/OvS-LoOP/training2_p2.log","a+");
        ...
        //   fp2 = fopen("/home/fil02/OvS-LoOP/aver.log","a+");
        ...
        //     fclose(fp2);
          ...
          float temp2;
        //   fp2= fopen("/home/fil02/OvS-LoOP/debug2_p2.log","a+");
          for(int i=0;i<p->data_counter2_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp2=fopen("/home/fil02/OvS-LoOP/time2_p2.log","a+");
        //   fprintf(fp2,"%lu\n",(end2_p2.tv_sec - start2_p2.tv_sec)*1000000+end2_p2.tv_usec-start2_p2.tv_usec);
        //   fclose(fp2);
        //   fp2=fopen("/home/fil02/OvS-LoOP/nor_training2_p2.log","a+");
        //   for(int i=0;i<p->data_counter2_p2;i++)
        //   {
      ...
      else if (p->training2 ==2)
      {
         ...
         p->loOP_status2 = LoOP_udate(p->state2,p->Data2);
          ...
          fp2= fopen("/home/fil02/OvS-LoOP/update2_p2.log","w+");
          fprintf(fp2,"%f\n",p->loOP_status2);
          fclose(fp2);
          }
      }
...
void abnormal_detect3(struct ofproto *p)
{
    ...
    //   fclose(fp3);
     ...
     {    
        ...
        //   fp3=fopen("/home/fil02/OvS-LoOP/training3.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing3=1;
          fp3=fopen("/home/fil02/OvS-LoOP/training3.log","a+");
        ...
        //   fclose(fp3);              
          ...
          float temp3;
        //   fp3= fopen("/home/fil02/OvS-LoOP/debug3.log","a+");
          for(int i=0;i<p->data_counter3;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp3=fopen("/home/fil02/OvS-LoOP/time3.log","a+");
        //   fprintf(fp3,"%lu\n",(end3.tv_sec - start3.tv_sec)*1000000+end3.tv_usec-start3.tv_usec);
        //   fclose(fp3);
        //   fp3=fopen("/home/fil02/OvS-LoOP/nor_training3.log","a+");
        //   for(int i=0;i<p->data_counter3;i++)
        //   {
      ...
      else if(p->training3 == 3)
      {
         ...
         p->loOP_status3 = LoOP_udate(p->state3,p->Data3);
          ...
          fp3= fopen("/home/fil02/OvS-LoOP/update3_p1.log","w+");
          fprintf(fp3,"%f\n",p->loOP_status3);
          fclose(fp3);
          }
      }
    //    fp3=fopen("/home/fil02/OvS-LoOP/count2.log","a+");
...
/*-------------------port2-----------------------*/
     ...
     {    
        ...
        //   fp3=fopen("/home/fil02/OvS-LoOP/training3_p2.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        // //if(fp3==NULL || p->writing3 == 1)
        ...
        {
          p->writing3_p2=1;
          fp3=fopen("/home/fil02/OvS-LoOP/training3_p2.log","a+");
        ...
        //   fclose(fp3);              
          ...
          float temp3_p2;
        //   fp3= fopen("/home/fil02/OvS-LoOP/debug3_p2.log","a+");
          for(int i=0;i<p->data_counter3_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp3=fopen("/home/fil02/OvS-LoOP/time3_p2.log","a+");
        //   fprintf(fp3,"%lu\n",(end3_p2.tv_sec - start3_p2.tv_sec)*1000000+end3_p2.tv_usec-start3_p2.tv_usec);
        //   fclose(fp3);
        //   fp3=fopen("/home/fil02/OvS-LoOP/nor_training3_p2.log","a+");
        //   for(int i=0;i<p->data_counter3_p2;i++)
        //   {
      ...
      else if(p->training3_p2 == 3)
      {
         ...
         p->loOP_status3_p2 = LoOP_udate(p->state3_p2,p->Data3_p2);
          ...
          fp3= fopen("/home/fil02/OvS-LoOP/update3_p2.log","w+");
          fprintf(fp3,"%f\n",p->loOP_status3_p2);
          fclose(fp3);
          }
      }
...
void abnormal_detect4(struct ofproto *p)
{
    ...
    //   fclose(fp4);
     ...
     {    
        ...
        //   fp4=fopen("/home/fil02/OvS-LoOP/training4.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing4=1;
          fp4=fopen("/home/fil02/OvS-LoOP/training4.log","a+");
        ...
        //   fclose(fp4);              
          ...
          float temp4;
        //   fp4= fopen("/home/fil02/OvS-LoOP/debug4.log","a+");
          for(int i=0;i<p->data_counter4;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp4=fopen("/home/fil02/OvS-LoOP/time4.log","a+");
        //   fprintf(fp4,"%lu\n",(end4.tv_sec - start4.tv_sec)*1000000+end4.tv_usec-start4.tv_usec);
        //   fclose(fp4);
        //   fp4=fopen("/home/fil02/OvS-LoOP/nor_training4.log","a+");
        //   for(int i=0;i<p->data_counter4;i++)
        //   {
      ...
      else if (p->training4 == 4)
      {
         ...
         p->loOP_status4 = LoOP_udate(p->state4,p->Data4);
          ...
          fp4= fopen("/home/fil02/OvS-LoOP/update4_p1.log","w+");
          fprintf(fp4,"%f\n",p->loOP_status4);
          fclose(fp4);
          }
     ...
     {    
        ...
        //   fp4=fopen("/home/fil02/OvS-LoOP/training4_p2.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing4_p2 = 1;
          fp4=fopen("/home/fil02/OvS-LoOP/training4_p2.log","a+");
        ...
        //   fclose(fp4);              
          ...
          float temp4_p2;
        //   fp4= fopen("/home/fil02/OvS-LoOP/debug4_p2.log","a+");
          for(int i=0;i<p->data_counter4_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp4=fopen("/home/fil02/OvS-LoOP/time4_p2.log","a+");
        //   fprintf(fp4,"%lu\n",(end4_p2.tv_sec - start4_p2.tv_sec)*1000000+end4_p2.tv_usec-start4_p2.tv_usec);
        //   fclose(fp4);
        //   fp4=fopen("/home/fil02/OvS-LoOP/nor_training4_p2.log","a+");
        //   for(int i=0;i<p->data_counter4_p2; i++)
        //   {
      ...
      else if (p->training4_p2 == 4)
      {
         ...
         p->loOP_status4_p2 = LoOP_udate(p->state4_p2, p->Data4_p2);
          ...
          fp4= fopen("/home/fil02/OvS-LoOP/update4_p2.log","w+");
          fprintf(fp4,"%f\n",p->loOP_status4_p2);
          fclose(fp4);
          }
     ...
     {    
        ...
        //   fp4=fopen("/home/fil02/OvS-LoOP/training4_p3.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing4_p3 = 1;
          fp4=fopen("/home/fil02/OvS-LoOP/training4_p3.log","a+");
        ...
        //   fclose(fp4);              
          ...
          float temp4_p3;
        //   fp4= fopen("/home/fil02/OvS-LoOP/debug4_p3.log","a+");
          for(int i=0;i<p->data_counter4_p3;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp4=fopen("/home/fil02/OvS-LoOP/time4_p3.log","a+");
        //   fprintf(fp4,"%lu\n",(end4_p3.tv_sec - start4_p3.tv_sec)*1000000+end4_p3.tv_usec-start4_p3.tv_usec);
        //   fclose(fp4);
        //   fp4=fopen("/home/fil02/OvS-LoOP/nor_training4_p3.log","a+");
        //   for(int i=0;i<p->data_counter4_p3; i++)
        //   {
      ...
      else if (p->training4_p3 == 4)
      {
         ...
         p->loOP_status4_p3 = LoOP_udate(p->state4_p3, p->Data4_p3);
          ...
          fp4= fopen("/home/fil02/OvS-LoOP/update4_p3.log","w+");
          fprintf(fp4,"%f\n",p->loOP_status4_p3);
          fclose(fp4);
          }
...
void abnormal_detect5(struct ofproto *p)
{
    ...
    //   fclose(fp5);
     ...
     {    
        ...
        //   fp5=fopen("/home/fil02/OvS-LoOP/training5.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing5=1;
          fp5=fopen("/home/fil02/OvS-LoOP/training5.log","a+");
        ...
        //   fclose(fp5);              
          ...
          float temp5;
        //   fp5= fopen("/home/fil02/OvS-LoOP/debug5.log","a+");
          for(int i=0;i<p->data_counter5;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp5=fopen("/home/fil02/OvS-LoOP/time5.log","a+");
        //   fprintf(fp5,"%lu\n",(end5.tv_sec - start5.tv_sec)*1000000+end5.tv_usec-start5.tv_usec);
        //   fclose(fp5);
        //   fp5=fopen("/home/fil02/OvS-LoOP/nor_training5.log","a+");
        //   for(int i=0;i<p->data_counter5;i++)
        //   {
      ...
      else if (p->training5 == 5)
      {
         ...
         p->loOP_status5 = LoOP_udate(p->state5,p->Data5);
          ...
          fp5= fopen("/home/fil02/OvS-LoOP/update5_p1.log","w+");
          fprintf(fp5,"%f\n",p->loOP_status5);
          fclose(fp5);
          }
      }
     ...
     {    
        ...
        //   fp5=fopen("/home/fil02/OvS-LoOP/training5_p2.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing5_p2=1;
          fp5=fopen("/home/fil02/OvS-LoOP/training5_p2.log","a+");
        ...
        //   fclose(fp5);              
          ...
          float temp5_p2;
        //   fp5= fopen("/home/fil02/OvS-LoOP/debug5_p2.log","a+");
          for(int i=0;i<p->data_counter5_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp5=fopen("/home/fil02/OvS-LoOP/time5_p2.log","a+");
        //   fprintf(fp5,"%lu\n",(end5_p2.tv_sec - start5_p2.tv_sec)*1000000+end5_p2.tv_usec-start5_p2.tv_usec);
        //   fclose(fp5);
        //   fp5=fopen("/home/fil02/OvS-LoOP/nor_training5_p2.log","a+");
        //   for(int i=0;i<p->data_counter5_p2;i++)
        //   {
      ...
      else if (p->training5_p2 == 5)
      {
         ...
         p->loOP_status5_p2 = LoOP_udate(p->state5_p2,p->Data5_p2);
          ...
          fp5= fopen("/home/fil02/OvS-LoOP/update5_p2.log","w+");
          fprintf(fp5,"%f\n",p->loOP_status5_p2);
          fclose(fp5);
          }
      }
...
void abnormal_detect6(struct ofproto *p)
{
    ...
    //   fclose(fp6);
     ...
     {    
        ...
        //   fp6=fopen("/home/fil02/OvS-LoOP/training6.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing6=1;
          fp6=fopen("/home/fil02/OvS-LoOP/training6.log","a+");
        ...
        //   fclose(fp6);              
          ...
          float temp6;
        //   fp6= fopen("/home/fil02/OvS-LoOP/debug6.log","a+");
          for(int i=0;i<p->data_counter6;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp6=fopen("/home/fil02/OvS-LoOP/time6.log","a+");
        //   fprintf(fp6,"%lu\n",(end6.tv_sec - start6.tv_sec)*1000000+end6.tv_usec-start6.tv_usec);
        //   fclose(fp6);
        //   fp6=fopen("/home/fil02/OvS-LoOP/nor_training6.log","a+");
        //   for(int i=0;i<p->data_counter6;i++)
        //   {
      ...
      else if (p->training6 == 6)
      {
         ...
         p->loOP_status6 = LoOP_udate(p->state6,p->Data6);
          ...
          fp6= fopen("/home/fil02/OvS-LoOP/update6_p1.log","w+");
          fprintf(fp6,"%f\n",p->loOP_status6);
          fclose(fp6);
          }
     ...
     {    
        ...
        //   fp6=fopen("/home/fil02/OvS-LoOP/training6_p2.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing6_p2=1;
          fp6=fopen("/home/fil02/OvS-LoOP/training6_p2.log","a+");
        //   if (!(current_flow6_p2 <=0 && current_traf6_p2 <=0))
        if (current_flow6_p2 != 0 && current_flow6_p2 != 0)
        ...
        //   fclose(fp6);              
          ...
          float temp6_p2;
        //   fp6= fopen("/home/fil02/OvS-LoOP/debug6_p2.log","a+");
          for(int i=0;i<p->data_counter6_p2;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp6=fopen("/home/fil02/OvS-LoOP/time6_p2.log","a+");
        //   fprintf(fp6,"%lu\n",(end6_p2.tv_sec - start6_p2.tv_sec)*1000000+end6_p2.tv_usec-start6_p2.tv_usec);
        //   fclose(fp6);
        //   fp6=fopen("/home/fil02/OvS-LoOP/nor_training6_p2.log","a+");
        //   for(int i=0;i<p->data_counter6_p2;i++)
        //   {
      ...
      else if (p->training6_p2 == 6)
      {
         ...
         p->loOP_status6_p2 = LoOP_udate(p->state6_p2,p->Data6_p2);
          ...
          fp6= fopen("/home/fil02/OvS-LoOP/update6_p2.log","w+");
          fprintf(fp6,"%f\n",p->loOP_status6_p2);
          fclose(fp6);
          }
     ...
     {    
        ...
        //   fp6=fopen("/home/fil02/OvS-LoOP/training6_p3.log","r");
        // /*check training file exist or not .if not exist or not enough data, recording.
        //   if exists , move to calculating*/
        ...
        {
          p->writing6_p3=1;
          fp6=fopen("/home/fil02/OvS-LoOP/training6_p3.log","a+");
        ...
        //   fclose(fp6);              
          ...
          float temp6_p3;
        //   fp6= fopen("/home/fil02/OvS-LoOP/debug6_p3.log","a+");
          for(int i=0;i<p->data_counter6_p3;i++)
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
        ...
        //   fp6=fopen("/home/fil02/OvS-LoOP/time6_p3.log","a+");
        //   fprintf(fp6,"%lu\n",(end6_p3.tv_sec - start6_p3.tv_sec)*1000000+end6_p3.tv_usec-start6_p3.tv_usec);
        //   fclose(fp6);
        //   fp6=fopen("/home/fil02/OvS-LoOP/nor_training6_p3.log","a+");
        //   for(int i=0;i<p->data_counter6_p3;i++)
        //   {
      ...
      else if (p->training6_p3 == 6)
      {
         ...
         p->loOP_status6_p3 = LoOP_udate(p->state6_p3,p->Data6_p3);
          ...
          fp6= fopen("/home/fil02/OvS-LoOP/update6_p3.log","w+");
          fprintf(fp6,"%f\n",p->loOP_status6_p3);
          fclose(fp6);
          }
